...
this.getSettings=function(){return this._settings},this.getId=function(){return this._id}};c.version="2.151.0.37016",c.NO_SESSION_KEY=-2,c.AdPosition={BUMPER:"BUMPER",PREROLL:"PREROLL",MIDROLL:"MIDROLL",
...
WINDOWS_DEVICE:"WIN",XBOX:"XB",KAIOS_DEVICE:"KAIOS"};var d=a.ClientSettings=function(a){function b(a){if(!C.isValidString(a))throw new Error("customerKey must be valid");this.customerKey=a}function c(a){
if(C.isValidString(a)){var b=a.split("://");if("cws.conviva.com"!=b[1]&&("https"==b[0]||"http"==b[0]))return a}return"https://"+e.customerKey+"."+d.defaultProductionGatewayDNS}var e=this;this._customerKey=null,
...
C.defGet(this,"heartbeatInterval",function(){return this._heartbeatInterval}),C.defSet(this,"heartbeatInterval",function(a){if("number"==typeof a){var b=C.NumberToUnsignedInt(a);b===a&&(this._heartbeatInterval=b);
...
return this.customerKey===a.customerKey&&this.gatewayUrl===a.gatewayUrl&&this.heartbeatInterval===a.heartbeatInterval},this.clone=function(){var a=new d(this.customerKey);return a.gatewayUrl=c(this.gatewayUrl),
a.heartbeatInterval=this.heartbeatInterval,a}};d.defaultDevelopmentGatewayUrl="https://conviva.testonly.conviva.com",d.defaultProductionGatewayUrl="https://cws.conviva.com",d.defaultProductionGatewayDNS="cws.conviva.com",
...
function a(){return this._assetName}function b(a){"string"==typeof a&&(this._assetName=a)}function c(){return this._custom}function d(a){"object"==typeof a&&(this._custom=C.sanitizeStringToStringObject(a));
}function f(){return this._defaultResource}function g(a){"string"==typeof a&&(this._defaultResource=a)}function h(){return this._viewerId}function i(a){"string"==typeof a&&(this._viewerId=a)}function j(){
return this._applicationName}function k(a){"string"==typeof a&&(this._applicationName=a)}function l(){return this._streamUrl}function m(a){"string"==typeof a&&(this._streamUrl=a)}function n(){return this._streamType;
}function o(a){(a===e.StreamType.UNKNOWN||a===e.StreamType.VOD||a===e.StreamType.LIVE)&&(this._streamType=a)}function p(){return this._duration}function q(a){this._duration=G.sanitizeSpecialIntegerValue(a);
...
C.defSet(this,"encodedFrameRate",s),t.apply(this,arguments),this.clone=function(){var a=new e;a.assetName=this.assetName,a.applicationName=this.applicationName,a.streamUrl=this.streamUrl,a.viewerId=this.viewerId,
a.defaultResource=this.defaultResource,a.streamType=this.streamType,a.duration=this.duration,a.encodedFrameRate=this.encodedFrameRate;for(var b in this.custom)a.custom[b]=this.custom[b];return a}};e.StreamType={
UNKNOWN:"UNKNOWN",LIVE:"LIVE",VOD:"VOD"};var f=(a.ErrorType={ERROR_UNKNOWN:"ERROR_UNKNOWN",ERROR_IO:"ERROR_IO",ERROR_TIMEOUT:"ERROR_TIMEOUT",ERROR_NULL_ASSET:"ERROR_NULL_ASSET",ERROR_MISSING_PARAMETER:"ERROR_MISSING_PARAMETER",
ERROR_NO_AD_AVAILABLE:"ERROR_NO_AD_AVAILABLE",ERROR_PARSE:"ERROR_PARSE",ERROR_INVALID_VALUE:"ERROR_INVALID_VALUE",ERROR_INVALID_SLOT:"ERROR_INVALID_SLOT",ERROR_3P_COMPONENT:"ERROR_3P_COMPONENT",ERROR_UNSUPPORTED_3P_FEATURE:"ERROR_UNSUPPORTED_3P_FEATURE",
ERROR_DEVICE_LIMIT:"ERROR_DEVICE_LIMIT",ERROR_UNMATCHED_SLOT_SIZE:"ERROR_UNMATCHED_SLOT_SIZE"},a.Events={AD_REQUESTED:"Conviva.AdRequested",AD_RESPONSE:"Conviva.AdResponse",AD_SLOT_STARTED:"Conviva.SlotStarted",
AD_ATTEMPTED:"Conviva.AdAttempted",AD_SLOT_ENDED:"Conviva.SlotEnded",AD_IMPRESSION_START:"Conviva.AdImpression",AD_START:"Conviva.AdStart",AD_FIRST_QUARTILE:"Conviva.AdFirstQuartile",AD_MID_QUARTILE:"Conviva.AdMidQuartile",
AD_THIRD_QUARTILE:"Conviva.AdThirdQuartile",AD_COMPLETE:"Conviva.AdComplete",AD_END:"Conviva.AdEnd",AD_IMPRESSION_END:"Conviva.AdImpressionEnd",AD_SKIPPED:"Conviva.AdSkipped",AD_ERROR:"Conviva.AdError",
AD_PROGRESS:"Conviva.AdProgress",AD_CLOSE:"Conviva.AdClose",CONTENT_PAUSED:"Conviva.PauseContent",CONTENT_RESUMED:"Conviva.ResumeContent",POD_START:"Conviva.PodStart",POD_END:"Conviva.PodEnd"},a.SystemFactory=function(a,b){
function c(a,b){if(!(a instanceof m))throw new Error("systemInterface parameter should be an instance of SystemInterface.");this._systemInterface=a,this._timeInterface=this._systemInterface._timeInterface,
...
this._loggingInterface=this._systemInterface._loggingInterface,b instanceof g?this._settings=b.clone():this._settings=new g}var d=this;c.apply(this,arguments),this.configure=function(a,b){this._packageName=a,
this._clientSettings=b},this.release=function(){this._systemInterface.release(),this._systemInterface=null,this._packageName=null,this._settings=null,this._logBuffer=null};var e={build:function(){return new I(d._loggingInterface,d._timeInterface,d.getSettings(),d._logBuffer,d._packageName);
}};this.buildLogger=function(){return e.build()},this.buildSessionFactory=function(a,b,c){return new w(a,b,c,this)},this.buildPing=function(){return new E(this.buildLogger(),this.buildHttpClient(),this._clientSettings);
},this.buildCallbackWithTimeout=function(){return new x(this.buildTimer())},this.buildCallbackWithTimeoutNoPing=function(){var a=null,b=new A(this.buildLogger(),a,this.getSettings()),c=new M(this.buildLogger(),this._timerInterface,b);
return new x(c)},this.buildHttpClient=function(){return new H(this.buildLogger(),this._httpInterface,this.buildCallbackWithTimeoutNoPing(),this.getSettings())},this.buildExceptionCatcher=function(){return new A(this.buildLogger(),this.buildPing(),this.getSettings());
...
e._currentMetadata={},e._renderedFrameRate=-1,e._encodedFrameRate=-1,e._duration=-1,e._playerVersion=null,e._playerType=null,e._streamUrl=null,e._lastError=null,e._pendingErrors=[]})},this.setCDNServerIP=function(a){
e._released||e._exceptionCatcher.runProtected("PlayerStateManager.setCDNServerIP",function(){null!=e._monitorNotifier&&e._monitorNotifier.onCDNServerIPChange(a)})},this.getError=function(){return e._lastError;
},d.apply(e,arguments),h.DEFAULT_SIGNAL_STRENGTH=1e3,h.DEFAULT_RENDERED_FRAME_RATE=-1,h.DEFAULT_BUFFER_LENGTH=-1,h.DEFAULT_PHT=-1};h.PlayerState={STOPPED:"STOPPED",PLAYING:"PLAYING",BUFFERING:"BUFFERING",
PAUSED:"PAUSED",UNKNOWN:"UNKNOWN",NOT_MONITORED:"NOT_MONITORED"},h.isValidPlayerState=function(a){return a===h.PlayerState.STOPPED||a===h.PlayerState.PLAYING||a===h.PlayerState.BUFFERING||a===h.PlayerState.PAUSED||a===h.PlayerState.UNKNOWN||a===h.PlayerState.NOT_MONITORED?!0:!1;
...
},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()});var d,e,f,g,h;"function"!=typeof p.stringify&&(d=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
...
r.REQUEST_CDN_SERVER_IP="csi",r.convertPlayerState=function(a){switch(a){case h.PlayerState.STOPPED:return r.eStopped;case h.PlayerState.PLAYING:return r.ePlaying;case h.PlayerState.BUFFERING:return r.eBuffering;
case h.PlayerState.PAUSED:return r.ePaused;case h.PlayerState.NOT_MONITORED:return r.eNotMonitored;default:return r.eUnknown}},r.eStopped=1,r.ePlaying=3,r.eBuffering=6,r.ePaused=12,r.eNotMonitored=98,r.eUnknown=100,
r.SessionFlags={GLOBAL:0,VIDEO:1,QUALITY_METRICS:2,BITRATE_METRICS:4},r.Capabilities={INSIGHTS:0};var s=(b.JSONInterface=function(){this.encode=function(a){},this.decode=function(a){}},b.LibJSONInterface=function(){
this.encode=function(a){var b=null;try{b=p.stringify(a)}catch(c){}return b},this.decode=function(a){var b=null;try{b=q(a)}catch(c){}return C.isObject(b)||(b=null),b}}),t=b.CwsHeartbeat=function(){function a(){}
this._data={},a.apply(this,arguments),this.get=function(){return this._data},this.setField=function(a,b){this._data[a]=b},this.setInnerField=function(a,b,c){this._data[a]||(this._data[a]={}),this._data[a][b]=c;
},this.setMessageType=function(a){this.setField(r.REQUEST_KEY_MESSAGE_TYPE,a)},this.setSessionTime=function(a){this.setField(r.REQUEST_KEY_SESSION_TIME,a)},this.setSessionStartTime=function(a){this.setField(r.REQUEST_KEY_SESSION_START_TIME,a);
...
},this.setCDNServerIP=function(a){this.setField(r.REQUEST_CDN_SERVER_IP,a)}},u=b.CwsSession=function(a,b,d,e,f,g,i,j,k,l,m){function n(a,b,c,d,e,f,g,h,i,j,k){this._eventQueue=a,this._client=b,this._clientSettings=c,
this._logger=d,this._logger.setModuleName("CwsSession"),this._exceptionCatcher=e,this._timer=f,this._gatewayControl=g,this._cwsProtocol=h,this._time=i,this._logBuffer=j,this._clientConfig=k}var o=this;o._heartbeatTimerCancel=null,
...
o._hasJoined=!1,o._cleanedUp=!1,o._willEndSoon=!1,o._rfpsTimerCancel=null,o._rfpsTimerInterval=1e3,o._playingFpsObservationCount=0,o._playingFpsTotal=0,n.apply(this,arguments),this.cleanup=function(){this._clientConfig=null,
...
this._client=null,this._eventQueue.flush(),this._eventQueue=null,this._cleanedUp=!0},this.start=function(a){this._session=a,this._global=this._session._global,this._logger.setSessionId(this._session._id),
this._startTimeMs=this._time.current(),(this.isVideoSession()||this.isAdSession())&&(this._sessionFlags+=u.DEFAULT_VIDEO_SESSION_FLAGS)},this.willEndSoon=function(){this._willEndSoon=!0},this.initialize=function(){
this._logger.debug("initialize()")},this.end=function(){(this.isVideoSession()||this.isAdSession())&&(this._logger.debug("end(): schedule the last hb before session cleanup"+o.sessionTypeTag()),this.enqueueSessionEndEvent()),
this.cancelHeartbeatTimer(),this.sendHeartbeat()},this.startSendingHeartbeats=function(){this._willEndSoon||(this.sendHeartbeat(),this.resetHeartbeatTimer())},this.setBrowserName=function(a){o._logger.debug("setBrowserName(): "+a);
var b=o._browserName;b!==a&&null!=a&&(o._logger.debug("Change browserName from "+b+" to "+a),o._browserName=a)},this.setBrowserVersion=function(a){o._logger.debug("setBrowserVersion(): "+a);var b=o._browserVersion;
b!==a&&null!=a&&(o._logger.debug("Change browserVersion from "+b+" to "+a),o._browserVersion=a)},this.setDeviceBrand=function(a){o._logger.debug("setDeviceBrand(): "+a);var b=o._deviceBrand;b!==a&&null!=a&&(o._logger.debug("Change deviceBrand from "+b+" to "+a),
o._deviceBrand=a)},this.setDeviceManufacturer=function(a){o._logger.debug("setDeviceManufacturer(): "+a);var b=o._deviceManufacturer;b!==a&&null!=a&&(o._logger.debug("Change deviceManufacturer from "+b+" to "+a),
o._deviceManufacturer=a)},this.setDeviceModel=function(a){o._logger.debug("setDeviceModel(): "+a);var b=o._deviceModel;b!==a&&null!=a&&(o._logger.debug("Change deviceModel from "+b+" to "+a),o._deviceModel=a);
},this.setDeviceType=function(a){o._logger.debug("setDeviceBrand(): "+a);var b=o._deviceType;b!==a&&null!=a&&(o._logger.debug("Change deviceType from "+b+" to "+a),o._deviceType=a)},this.setDeviceVersion=function(a){
...
o.enqueueLinkEncryptionChangeEvent(b,a),o._linkEncryption=a)},this.setCDNServerIP=function(a){o._logger.debug("setCDNServerIP(): "+a);var b=o._cdnServerIP;b!==a&&C.isValidString(a)&&(o._logger.debug("Change CDN Server IP from "+b+" to "+a),
o.enqueueCDNServerIPChangeEvent(b,a),o._cdnServerIP=a)},this.togglePauseJoin=function(a){if(o._logger.debug("togglePauseJoin()"),o._pauseJoin===a)return void o._logger.debug("togglePauseJoin(): same value, ignoring");
...
this.declareStateChange(c,d)},this.enqueueCDNServerIPChangeEvent=function(a,b){var c={},d={};C.isValidString(a)&&(d[r.REQUEST_CDN_SERVER_IP]=a),c[r.REQUEST_CDN_SERVER_IP]=b,this.declareStateChange(c,d);
},this.enqueuePauseJoinChangeEvent=function(a,b){var c={},d={};d[r.REQUEST_KEY_PAUSE_JOIN]=a,c[r.REQUEST_KEY_PAUSE_JOIN]=b,this.declareStateChange(c,d)},this.enqueuePlayerStateChangeEvent=function(a,b){
...
C.isValidString(o._cdnServerIP)&&b.setCDNServerIP(o._cdnServerIP),b.setPlatformMetadataSchema(r.SDK_METADATA_SCHEMA),null!=o._browserName&&b.setBrowserName(o._browserName),null!=o._browserVersion&&b.setBrowserVersion(o._browserVersion),
null!=o._deviceBrand&&b.setDeviceBrand(o._deviceBrand),null!=o._deviceManufacturer&&b.setDeviceManufacturer(o._deviceManufacturer),null!=o._deviceModel&&b.setDeviceModel(o._deviceModel),null!=o._deviceType&&b.setDeviceType(o._deviceType),
null!=o._deviceVersion&&b.setDeviceVersion(o._deviceVersion),null!=o._frameworkName&&b.setFrameworkName(o._frameworkName),null!=o._frameworkVersion&&b.setFrameworkVersion(o._frameworkVersion),null!=o._operatingSystemName&&b.setOperatingSystemName(o._operatingSystemName),
...
var i=o.compileHeartbeatInfos();i.length>0&&b.setHeartbeatInfos(i)}return 0==o._heartbeatSequenceNumber&&(b=o.cloneHearbeatWithBrowserTags(b)),b.setSessionStartTime(o._startTimeMs),b.setSessionTime(o.getSessionTime()),
o._heartbeatSequenceNumber++,b.get()},this.cloneHearbeatWithBrowserTags=function(a){var b=o.getBrowserMetadata();if("{}"!==JSON.stringify(b)){var c=C.ObjectShallowCopy(b);for(var d in a._data.tags)c[d]=a._data.tags[d];
a._data.tags=c;var e={};e[r.REQUEST_KEY_TAGS]=b;var f={};if(f[r.REQUEST_STATE_CHANGE_EVENT_KEY_NEW]=e,f[r.REQUEST_EVENT_KEY_TYPE]=r.EVENT_TYPE_STATE_CHANGE,f[r.REQUEST_EVENT_KEY_SESSION_TIME]=o.getSessionTime(),
f[r.REQUEST_EVENT_KEY_SEQUENCE_NUMBER]=o._eventQueue.getNumber(),o._playerStateManager){var g=G.Integer(o._playerStateManager.getPHT(),0,null,-1),h=G.Integer(o._playerStateManager.getBufferLength(),0,null,-1);
g>=0&&(f[r.REQUEST_KEY_PLAYHEAD_TIME]=g),h>0&&(f[r.REQUEST_KEY_BUFFER_LENGTH]=h)}return void 0==a._data.evs&&(a._data.evs=[]),a._data.evs.push(f),a}return a},this.getBrowserMetadata=function(){var a={};
if(null!=navigator){if(a["fp.cookie"]="undefined"!=typeof navigator.cookieEnabled?""+navigator.cookieEnabled:"",a["fp.memory"]=""+navigator.deviceMemory,a["fp.hwConc"]=null!=navigator.hardwareConcurrency&&void 0!=navigator.hardwareConcurrency?""+navigator.hardwareConcurrency:"",
a["fp.java"]=""+navigator.javaEnabled(),a["fp.lang"]=null!=navigator.language&&void 0!=navigator.language?""+navigator.language:"",a["fp.langs"]=null!=navigator.languages&&navigator.languages.length>0?""+navigator.languages.toString():"",
a["fp.maxTp"]=null!=navigator.maxTouchPoints&&void 0!=navigator.maxTouchPoints?""+navigator.maxTouchPoints:"",a["fp.plugins"]="",null!=navigator.plugins&&navigator.plugins.length>0)for(var b=0;b<navigator.plugins.length;b++)a["fp.plugins"]+=navigator.plugins[b].name+",";
if(a["fp.mime"]="",null!=navigator.mimeTypes&&navigator.mimeTypes.length>0)for(var c=0;c<navigator.mimeTypes.length;c++)a["fp.mime"]+=navigator.mimeTypes[c].type+",";a["fp.sysLang"]=null!=navigator.systemLanguage&&void 0!=navigator.systemLanguage?""+navigator.systemLanguage:"",
a["fp.availHeight"]=null!=window.screen&&null!=window.screen.availHeight?""+window.screen.availHeight:"",a["fp.availWidth"]=null!=window.screen&&null!=window.screen.availWidth?""+window.screen.availWidth:"",
a["fp.height"]=null!=window.screen&&null!=window.screen.height?""+window.screen.height:"",a["fp.width"]=null!=window.screen&&null!=window.screen.width?""+window.screen.width:"",a["fp.colorDepth"]=null!=window.screen&&null!=window.screen.colorDepth?""+window.screen.colorDepth:"",
a["fp.deviceXDPI"]=null!=window.screen&&null!=window.screen.deviceXDPI?""+window.screen.deviceXDPI:"",a["fp.deviceYDPI"]=null!=window.screen&&null!=window.screen.deviceYDPI?""+window.screen.deviceYDPI:"",
a["fp.dpi"]=null!=window.devicePixelRatio?""+window.devicePixelRatio:"",a["fp.secure"]=null!=window.isSecureContext?""+window.isSecureContext:"",a["fp.platform"]=null!=navigator.platform&&void 0!=navigator.platform?""+navigator.platform:"",
a["fp.product"]=null!=navigator.product&&void 0!=navigator.product?""+navigator.product:"",a["fp.productSub"]=null!=navigator.productSub&&void 0!=navigator.productSub?""+navigator.productSub:"",a["fp.vendor"]=null!=navigator.vendor&&void 0!=navigator.vendor?""+navigator.vendor:"",
a["fp.vendorSub"]=null!=navigator.vendorSub&&void 0!=navigator.vendorSub?""+navigator.vendorSub:""}return a},this.sendHeartbeat=function(){if(!o._cleanedUp){var a=o.makeHeartbeat();null!=a&&o.postHeartbeat(a);
}},this.countRfps=function(){if(o._playerState===h.PlayerState.PLAYING){var a=o._playerStateManager.getRenderedFrameRate();a>=0&&(o._playingFpsTotal+=a,o._playingFpsObservationCount++)}},this.updateAverageFrameRate=function(){
if(o._playerState===h.PlayerState.PLAYING){var a=o._playerStateManager.getRenderedFrameRate();if(a>=0){o._playingFpsTotal+=a,o._playingFpsObservationCount++;var b=C.Int32.Cast(1*o._playingFpsTotal/o._playingFpsObservationCount);
return b}return-1}return-1},this.postHeartbeat=function(a){o.createHeartbeatInfo();var b=o._heartbeatSequenceNumber-1;o._logger.info("postHeartbeat(): Send HB["+b+"]"+o.sessionTypeTag());var c=function(a,c){
o.onHeartbeatResponse(a,c,b)};o._gatewayControl.send(a,c)},this.onHeartbeatResponse=function(a,b,c){o._cleanedUp||o._exceptionCatcher.runProtected("onHeartbeatResponse",function(){if(a){var d=b;if(null!=d){
o._logger.debug("onHeartbeatResponse(): received valid response for HB["+c+"]"),o.updateHeartbeatInfoOnSuccess(c);var e=d[r.RESPONSE_KEY_CLIENT_ID];null!=e&&e!=o._clientConfig.get(y.CONFIG_KEY_CLIENT_ID)&&(o._logger.debug("onHeartbeatResponse(): setting the client id to "+e+" (from gateway)"),
...
this.onLinkEncryptionChange=function(a){},this.onSignalStrengthChange=function(a){},this.onError=function(a,b){},this.onRelease=function(){},this.onCDNServerIPChange=function(a){}},b.Session=function(){
function b(a,b,c,d,e,f,g,h){this._id=a,this._global=b,this._contentMetadata=c,this._clientConfig=d,this._systemMetadata=e,this._cwsSession=f,this._exceptionCatcher=g,this._logger=h,this._logger.setModuleName("Session"),
this._logger.setSessionId(C.ToString(this._id))}var c=this;c._contentMetadata=null,c._playerStateManager=null,c._id=0,c._global=u.SESSION_TYPE.VIDEO,c._cleaningUp=!1,c._cleanedUp=!1,c._adPlaying=!1,c._adStream=null,
...
c._ignoreError=!1,b.apply(c,arguments),this.start=function(){if(c.isVideoSession()||c.isAdSession()?c._logger.info("start(): assetName="+c._contentMetadata.assetName):c._logger.info("start()"+c.sessionTypeTag()),
c._cwsSession.start(this),c._clientConfig.isReady())c.initiateSession();else{var a=function(){c.initiateSession()};c._clientConfig.register(a)}},this.cleanup=function(){if(c._logger.info("cleanup()"+c.sessionTypeTag()),
c._cleaningUp=!0,c._cwsSession.willEndSoon(),c._clientConfig.isReady())c.endCwsSessionAndCleanupAll();else{var a=function(){c.endCwsSessionAndCleanupAll()};c._clientConfig.register(a)}},this.cleanupAll=function(){
...
c._exceptionCatcher=null,c._client=null,c._clientConfig=null,c._systemMetadata=null,c._cwsSession.cleanup(),c._cwsSession=null,c._cleanedUp=!0},this.endCwsSessionAndCleanupAll=function(){c._cwsSession.end(),
c.cleanupAll()},this.initiateSession=function(){c._cwsSession.initialize(),c.setStatesFromSystemMetadata(),(c.isVideoSession()||c.isAdSession())&&(c.setStatesFromContentMetadata(),c.enqueueEventForContentMetadata()),
c._cwsSession.startSendingHeartbeats()},this.enqueueEventForContentMetadata=function(){var b={};if(null!=c._contentMetadata.assetName?b[r.REQUEST_KEY_ASSET_NAME]=c._contentMetadata.assetName:c._logger.warning("enqueueEventForContentMetadata(): assetName was not set."),
...
null!=c._contentMetadata.streamUrl?b[r.REQUEST_KEY_STREAM_URL]=c._contentMetadata.streamUrl:c._logger.warning("enqueueEventForContentMetadata(): streamUrl was not set."),null!=c._contentMetadata.viewerId?("undefined"==typeof b[r.REQUEST_KEY_STREAM_METADATA_CHANGE]&&(b[r.REQUEST_KEY_STREAM_METADATA_CHANGE]={}),
...
},this.onCDNServerIPChange=function(a){c._logger.debug("onCDNServerIPChange(): "+a),c._cwsSession.setCDNServerIP(a)},this.onError=function(a,b){c._logger.debug("onError(): "+a+" ("+b+")"),c.reportError(a,b);
},this.onRelease=function(){c._logger.debug("onRelease()"),c.detachPlayer()},this.adStart=function(b,d,e){return c._logger.debug("adStart(): adStream="+b+" adPlayer="+d+" adPosition="+e),c._adPlaying?void c._logger.warning("adStart(): multiple adStart calls, ignoring"):(c._adPlaying=!0,
